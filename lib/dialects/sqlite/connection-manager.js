...
class ConnectionManager extends AbstractConnectionManager {
  ...
  getConnection(options) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const { sqliteEncrypOption } = this.sequelize.options
      if ( sqliteEncrypOption && Array.isArray(sqliteEncrypOption) ) {
        return sqliteEncrypOption.map(sql => new Promise(function (resolve,reject) {
